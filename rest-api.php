...
$config["abs_url_images"] 		= "http://www.emptyjourneys.com/mobile/media/image/" ; 		//Absolute Images URL
$config["abs_url_videos"] 		= "http://www.emptyjourneys.com/mobile/media/media/" ; 		//Absolute Videos URL
$config["abs_url_audios"] 		= "http://www.emptyjourneys.com/mobile/media/media/" ; 		//Absolute Audio URL
$config["abs_url_files"] 		= "http://www.emptyjourneys.com/mobile/media/file/" ; 		//Absolute Files URL
...
switch($_GET["json"]){	
	...
	case "route":		$rest_api=array();
		...
		$rest_api["routes"][4]["tb_version"] = "Upd.1801060348";
