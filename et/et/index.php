...
if(!empty($_REQUEST)){
    $tf = clean($_REQUEST["departure"]);
    $tt = clean($_REQUEST["destination"]);
    $td = clean($_REQUEST["transit_date"]);
}
                ...
                <div class="row">
                    ...
                    <div class="col-md-12 row">
                      <div class="form-group col-md-4" method="get">
                                ...
                                <div class="form-group col-md-4">
                                    <input type="date" name="transit_date" value="<?=$td?>">
                                    ...
                                    <div class="col-md-2"> 
                                        ...
                                        <button class="btn btn-success btn-rounded col-md-12"><i class="mdi mdi-account-search"></i> Search</button>
                                    ...
                                    <!-- <a href="login.php" type="button" class="btn btn-info btn-rounded col-md-12" >Request a Truck</a> -->
                ...
                // spill($_SESSION);
                    ...
                    $day = date_format(new DateTime($td),"Dd M Y");
                        if(!empty($trucks1)){
                            ...
                            echo "<button class='m-2 btn btn-warning'>0 Trucks found on ".date_format( new DateTime(@$td),'Dd M Y')." from $tff to $ttt</button>";
                        }
...
function getcard($trucks, $head){
    ?>
                 <div class="card">
                            <div class="card-block">
                                <h4 class="card-title bg-warning p-2"><?php echo $head ?></h4>
...
<?php $x =1; foreach($trucks as $tr=>$u): ?>
                                            <tr>
                                                ...
                                                <td><?=$u["town_from"]?></td>
                                                <td><?=$u["town_to"]?></td>
                                                <td><span class="label label-danger"><?=$u["depature_time"]?></span> </td>
                                                <!-- <td>Road</td> -->
                                                <td><?=$u["truck"]?></td>
