...
<?php 
    if(!empty($_POST)){
        ...
        if($p == $p2){
           ...
           if(insert("truck_users")){success("<div class='alert alert-success'>
<button type='button' class='close' data-dismiss='alert' aria-label='Close'> <span aria-hidden='true'>×</span> </button>
<h3 class='text-success'><i class='fa fa-check-circle'></i> Success</h3>Registration successful. <a href='login.php>'Please Login</a></div>");}
        }
    }
?>
                <div class="row card " style="margin-top:5%;">
                 ...
                 <div class="container col-md-6 ">
                     ...
                     <h2 class="text-center" style='margin-top:5%;'>Register As A Customer</h2>
                                    ...
                                    <!-- <div class="col-sm-12"> -->
                                        <div class="h6">
                                            <!-- <label class="custom-control custom-checkbox"> -->
                                                ...
                                                <small class="custom-control-description"><a href="">By clicking on Register button, you acknoledge to accept Terms of Use. Thank You*</a></small>
                                            <!-- </label> -->
                                        <!-- </div> -->
