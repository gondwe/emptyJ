...
echo '<div class="card col-md-5" style="padding:20px 20px 20px 20px" > ';
echo "<h4>Truck Details</h4>";
echo '<div class="row">';
echo '<div class="col-md-6">';
echo "<div><img src='".getimage("truck/".$truck[0]["photo"])."' width=200 ></div>";
echo '</div>';
...
echo '<div class="col-md-6 card " style="margin-left:20px; padding:20px 20px 20px 20px">';
echo "<h4>Driver Details</h4>";

echo '<div class="row">';
echo '<div class="col-md-6">';
echo "<div><img src ='".getimage("truck_driver/".$driver[0]["photo"])."' width=200  ></div>";
echo '</div>';
...
<?php if($status){ ?>
<button class="btn btn-info" type='button' value="0">Driver Approved</button>
<?php }else{ ?>
<input type="hidden" name="status" value="1">
<button class="btn btn-danger btn-block" type='submit' >Approve</button>
<?php } ?>
</form>
</div>               
</div>               
