                      ...
                      <div class="form-group col-md-4" method="get">
                                ...
                                <div class="form-group col-md-4">
                                    ...
                                    <div class="col-md-3">
                                     ...
                                     <a href="login.php" type="button" class="btn btn-danger btn-rounded col-md-12" ><i class="mdi mdi-car-connected"></i>  Request a Truck</a> 
...
function getcard($trucks, $head){
    ?>
                 <div class="card">
                            <div class="card-block">
                                <h4 class="card-title bg-info p-2" style="color: white;"><?php echo $head ?></h4>
