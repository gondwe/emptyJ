...
<a href="./schedule.php"><button class="m-3 btn btn-info">New Schedule</button></a>
...
<?php 
    ...
    if(!empty($data)) {
        ...
        echo "<tr><thead class='bg-info'>"; foreach($ths as $th){ echo "<th style='color:#fff;'>".rx($th)."</th>"; }echo "<th style='color:#fff;'>Action</th>"; echo "</thead></tr>";
        echo "<tbody>";
        $x = 1;
